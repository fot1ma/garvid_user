...
import '../css/FullNavbar.css'
import InpLogin from '../js/InpLogin'
function sa() {
        ...
        <div>
            <section className='navbar'>
                <div className="navbar-ul">
                    <ul>
                        <li className='moto-menu-item'><a href="/">{state1 === "eng" ? "User" : "Пользователь"}</a></li>
                        ...
                        <li className='moto-menu-item'><a href="/ourteam">{state1 === "eng" ? "Partnyor" : "Партнер"}</a></li>
                        <li className='moto-menu-item'><a href="/contact">{state1 === "eng" ? "Login" : "Логин"}</a></li>
                    </ul>
                        ...
                        <div className="media-ul">
                            <div className="dfdf">
                                <ul>
                                    ...
                                    <li><a href="" className='tt'>Логин</a></li>
                                </ul>
